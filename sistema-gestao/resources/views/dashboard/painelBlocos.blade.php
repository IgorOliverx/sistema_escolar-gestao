...
@section('content')
    ...
    <div class="main-content" id="main-content">
        <div class="sidebar" id="sidebar">
            ...
            <a href="#" class="room-link" data-room="COMPETIDOR"><i class="fa-solid fa-users"></i> Sala Competidores</a>
            <a href="#" class="room-link" data-room="ROBOTICA"><i class="fa-solid fa-users"></i> Sala Robótica</a>
            <a href="#" class="room-link" data-room="MANUFATURA"><i class="fa-solid fa-users"></i> Sala Manufatura</a>
