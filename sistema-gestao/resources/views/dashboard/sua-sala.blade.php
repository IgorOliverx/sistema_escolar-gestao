    ...
    <div class="main-content" id="main-content">
        ...
        <div class="menu-lateral">
            <article class="article">
                <svg style="width: 120px; height: 60px" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                    viewBox="0 0 256 256">
                    <g fill="none">
                ...
                <h4 class="nome-fessor">{{ $nomeProfessor }}</h4>
        ...
        <div class="content" id="content">
            ...
            <div class="modal" style="overflow: hidden">
                <div class="content" style="overflow: hidden">
                    <input type="text" class="form-control mb-3" placeholder="Digite o número do patrimonio"
                        id="search-ativo">
                    <div class="table-responsive"
                        style="
                                    ...
                                    <tr class="class-ativo">
                                        ...
                                        <td>
                                            <a class="btn btn-warning text-blue-500"
                                                href="{{ route('manutencao', ['ativo' => $ativo->id]) }}">Manutenção</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
